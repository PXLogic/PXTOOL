...
const CHAT_STORAGE_KEY = 'pxtool-mcp-sessions';
const CURRENT_SESSION_KEY = 'pxtool-mcp-current-session';
...
function saveSettings(settings: AppSettings) {
  localStorage.setItem('pxtool-mcp-settings', JSON.stringify(settings));
}
